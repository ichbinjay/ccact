      ...
      <div id="databox">
        <div id="topdiv">
          <div id="studentData">
            ...
            "root" , "root" ); Statement stmt=con.createStatement(); String rno
            = session.getAttribute("uname").toString(); String query = "select fname,lname from stuname where regno='"+rno+"'"; ResultSet
        ...
        <div id="bottomdiv">
          <div id="dataTable">
            <table id="dataTable" border="1">
              ...
              <% query="select cno, cname, stat from participated where regno="
              +(String)rno; rs=stmt.executeQuery(query); while(rs.next()) { %>
              <tr>
                <td><%=rs.getInt(1)%></td>
